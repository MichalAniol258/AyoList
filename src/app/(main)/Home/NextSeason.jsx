...
// Wyciągnięcie SVG poza komponent jako stałe
const SVG_ITEMS = [
    {
        icon: (
            <svg data-v-4d8937d6="" aria-hidden="true" focusable="false" data-prefix="far" data-icon="smile" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" color="var(--green)" className="hover-Image">
                <path data-v-4d8937d6="" fill="currentColor" d="M248 8C111 8 0 119 0 256s111 248 248 248 248-111 248-248S385 8 248 8zm0 448c-110.3 0-200-89.7-200-200S137.7 56 248 56s200 89.7 200 200-89.7 200-200 200zm-80-216c17.7 0 32-14.3 32-32s-14.3-32-32-32-32 14.3-32 32 14.3 32 32 32zm160 0c17.7 0 32-14.3 32-32s-14.3-32-32-32-32 14.3-32 32 14.3 32 32 32zm4 72.6c-20.8 25-51.5 39.4-84 39.4s-63.2-14.3-84-39.4c-8.5-10.2-23.7-11.5-33.8-3.1-10.2 8.5-11.5 23.6-3.1 33.8 30 36 74.1 56.6 120.9 56.6s90.9-20.6 120.9-56.6c8.5-10.2 7.1-25.3-3.1-33.8-10.1-8.4-25.3-7.1-33.8 3.1z"></path>
            </svg>
        )
    },
    {
        icon: (
            <svg data-v-4d8937d6="" aria-hidden="true" focusable="false" data-prefix="far" data-icon="meh" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" color="var(--orange)" className="hover-Image">
                <path data-v-4d8937d6="" fill="currentColor" d="M248 8C111 8 0 119 0 256s111 248 248 248 248-111 248-248S385 8 248 8zm0 448c-110.3 0-200-89.7-200-200S137.7 56 248 56s200 89.7 200 200-89.7 200-200 200zm-80-216c17.7 0 32-14.3 32-32s-14.3-32-32-32-32 14.3-32 32 14.3 32 32 32zm160-64c-17.7 0-32 14.3-32 32s14.3 32 32 32 32-14.3 32-32-14.3-32-32-32zm8 144H160c-13.2 0-24 10.8-24 24s10.8 24 24 24h176c13.2 0 24-10.8 24-24s-10.8-24-24-24z"></path>
            </svg>
        )
    },
    {
        icon: (
            <svg data-v-4d8937d6="" aria-hidden="true" focusable="false" data-prefix="far" data-icon="frown" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" color="var(--red)" className="hover-Image">
                <path data-v-4d8937d6="" fill="currentColor" d="M248 8C111 8 0 119 0 256s111 248 248 248 248-111 248-248S385 8 248 8zm0 448c-110.3 0-200-89.7-200-200S137.7 56 248 56s200 89.7 200 200-89.7 200-200 200zm-80-216c17.7 0 32-14.3 32-32s-14.3-32-32-32-32 14.3-32 32 14.3 32 32 32zm160-64c-17.7 0-32 14.3-32 32s14.3 32 32 32 32-14.3 32-32-14.3-32-32-32zm-80 128c-40.2 0-78 17.7-103.8 48.6-8.5 10.2-7.1 25.3 3.1 33.8 10.2 8.4 25.3 7.1 33.8-3.1 16.6-19.9 41-31.4 66.9-31.4s50.3 11.4 66.9 31.4c8.1 9.7 23.1 11.9 33.8 3.1 10.2-8.5 11.5-23.6 3.1-33.8C326 321.7 288.2 304 248 304z"></path>
            </svg>
        )
    }
];

// Hook do window width wyciągnięty poza komponent
...
function formatTimeRemaining(timeUntilAiring) {
...
// Funkcja pomocnicza do formatowania formatów
...
function NextSeasonComponent() {
    ...
    const media = useMemo(() => dataNext?.Page?.media || [], [dataNext]);

    // Memoizacja funkcji content
            ...
            <div className="hover-data-right">
                <div className="hover-header">
                    ...
                    <div className="hover-score">
                        {item.meanScore >= 75 && SVG_ITEMS[0].icon}
                        {(item.meanScore <= 74 && item.meanScore >= 60) && SVG_ITEMS[1].icon}
                        {(item.meanScore <= 59 && item.meanScore !== null) && SVG_ITEMS[2].icon}
    ...
    // Memoizacja przefiltrowanych mediów
    const displayedMedia = useMemo(() => {
        return media.slice(0, limit);
    }, [media, limit]);

    if (errorNext) return <p>Rozjebalo sie cos: {errorNext.message}</p>;
...
const NextSeason = memo(NextSeasonComponent)
